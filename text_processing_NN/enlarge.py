...
INITIAL_REGULARIZER = 0.0042
MAX_REGULARIZER = 0.0043
REGULARIZER_STEP = 0.00001
NEURONS = 64 
OUTPUT_JSON_FILE = f"training_data_output/{NEURONS}_enlarged.json"
...
while current_regularizer <= MAX_REGULARIZER:
    ...
    print(f"L2 Regularizer: {current_regularizer:.6f}")
    ...
    current_regularizer = round(current_regularizer + REGULARIZER_STEP, 6) 
